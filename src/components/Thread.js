...
const Thread = ({user, setOpenPopUp, filteredThread, getThreads}) => {
    ...
    return (
        <article className="feed-card">
            ...
            <div className="icons">
                <svg onClick={postLike} clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2"
                ...
                <svg onClick={handleClick} xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                     viewBox="0 0 24 24">
                    <path
